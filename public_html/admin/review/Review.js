class Review extends CRUDTable {
    ...
    init() { 
        CRUDTable.updUrl = '../../../api/admin_api/review/adUpdate.php';
        CRUDTable.insUrl = '../../../api/admin_api/review/adInsert.php';
        CRUDTable.delUrl = '../../../api/admin_api/review/adDelete.php';
